...
import { User, JobWithSiteInfo } from '../types';
import { jobService } from '../services/jobService';
import { timeService } from '../services/timeService';
import { LoadingSpinner } from './LoadingSpinner';
import { CalendarDaysIcon, MapPinIcon, CheckCircleIcon, ClipboardIcon } from './icons';
...
const JobCard: React.FC<JobCardProps> = ({ job, isExpanded, onToggleExpand, onMarkComplete, onCopyAddress, isCompleting, isLogged, isToday }) => {
...
export const DailyJobsPage: React.FC<DailyJobsPageProps> = ({ user }) => {
  ...
  const handleToggleExpand = (jobId: string) => {
    setExpandedJobId(currentId => (currentId === jobId ? null : jobId));
  };
